...
function citylogic_customizer_library_options() {
	...
	$primary_color = '#196290';
	$secondary_color = '#144e73';
	$link_color = '#788F98';
	$link_rollover_color = '#144e73';

	$footer_color = '#F4F4F4';

	// Fonts
	$site_title_font_color = '#196290';
    ...
    $panels[] = array(
    	...
    	// Links - Sub-section
	    $section = 'citylogic-styling-links';
	    
	    $sections[] = array(
	    	'id' => $section,
	    	'title' => __( 'Links', 'citylogic' ),
	    	'panel' => $panel
	    );
	    
	    $options['citylogic-content-links-have-underlines'] = array(
	    	'id' => 'citylogic-content-links-have-underlines',
	    	'label'   => __( 'Underline', 'citylogic' ),
	    	'section' => $section,
	    	'type'    => 'checkbox',
	    	'default' => 0
	    );
	    ...
	    // Plugins - Sub-section
	    $section = 'citylogic-styling-plugins';
	     
	    $sections[] = array(
    		'id' => $section,
    		'title' => __( 'Plugins', 'citylogic' ),
    		'panel' => $panel,
    		'description' => __( 'CityLogic adds custom styling to support external plugins:', 'citylogic' )
	    );

	    /*
	    $options['citylogic-bbpress-use-theme-styles'] = array(
    		'id' => 'citylogic-bbpress-use-theme-styles',
    		'label'   => __( 'BBPress', 'citylogic' ),
    		'section' => $section,
    		'type'    => 'checkbox',
    		'default' => 1,
    		'description' => ''
	    ...
	    */
	    ...
	    $options['citylogic-bookingpress-use-theme-styles'] = array(
    		'id' => 'citylogic-bookingpress-use-theme-styles',
    		'label'   => __( 'BookingPress', 'citylogic' ),
    		'section' => $section,
    		'type'    => 'checkbox',
    		'default' => 1,
    		'description' => ''
    ...
    $options['citylogic-layout-display-homepage-page-title'] = array(
    	'id' => 'citylogic-layout-display-homepage-page-title',
    	'label'   => __( 'Display page title on homepage', 'citylogic' ),
    	'section' => $section,
    	'type'    => 'checkbox',
    	'default' => 0
    );
    ...
    $options['citylogic-slider-enabled-warning'] = array(
    	...
    	'label'   => __( 'Please note: The header image will not display on your site as the slider is currently enabled. To make the header image visible you will first need to disable the <a href="#citylogic-slider" rel="tc-section">slider</a>.', 'citylogic' ),
    	'section' => $section,
    	'type'    => 'warning',
    	'priority' => 0
    );
    ...
    $options['citylogic-header-image-text'] = array(
    	...
    	'section' => $section,
    	'type'    => 'textarea',
    	'default' => __( '<h1>Super Adaptable</h1><p>Anything and everything you need</p>', 'citylogic' ),
    	'description' => esc_html( __( 'Use <h1></h1> or <h2></h2> tags around heading text and <p></p> tags around body text.', 'citylogic' ) ),
    	'sanitize_callback' => 'wp_kses_post'
    );
	...
	if ( citylogic_is_woocommerce_activated() ) {
	    ...
	    $panels[] = array(
			...
			$options['citylogic-woocommerce-header-cart-auto-update'] = array(
		    	'id' => 'citylogic-woocommerce-header-cart-auto-update',
		    	'label'   => __( 'Auto Update Header Cart', 'citylogic' ),
		    	'description' => __( 'This will auto-update the header cart as products are added or removed. <strong>Please note:</strong> If you are running a multilingual site then you should disable this setting for the header cart translations to function correctly', 'citylogic' ),
		    	'section' => $section,
		    	'type'    => 'checkbox',
		    	'default' => 1
		    );
    ...
    $options['citylogic-fonts-info'] = array(
    	'id' => 'citylogic-fonts-info',
    	'label'   => '',
    	'section' => $section,
    	'type'    => 'info',
    	'description' => __( '<a href="https://www.outtheboxthemes.com/documentation/citylogic/fonts/preview-page/" rel="nofollow" target="_blank">Struggling to find the right font? Read more about our theme fonts preview tool</a>', 'citylogic' )
    );
    
    // Font Awesome Settings
    $section = 'citylogic-font-awesome';
    $font_choices = customizer_library_get_font_choices();
    
    $sections[] = array(
    	'id' => $section,
    	'title' => __( 'Font Awesome', 'citylogic' ),
    	'priority' => '30'
    );
    ...
    $options['citylogic-font-awesome-version'] = array(
    	...
    	'label'   => __( 'Version', 'citylogic' ),
    	'section' => $section,
    	'type'    => 'select',
    	'choices' => $choices,
    	'default' => 'latest',
    	'description' => __( 'Select the version of Font Awesome that you would like to use. <strong>Icon variation will occur between the versions.</strong>', 'citylogic' )
    );
    ...
    // 404 Page Settings
    $section = 'citylogic-404-page';

    $sections[] = array(
        'id' => $section,
        'title' => __( '404 Page', 'citylogic' ),
        'priority' => '50'
    );
    ...
    $section = 'citylogic-privacy-and-legal';
    
    $sections[] = array(
    	'id' => $section,
    	'title' => __( 'Privacy & Legal', 'citylogic' ),
    	'priority' => '50'
    );

	$options['citylogic-show-recaptcha-badge'] = array(
    	'id' => 'citylogic-show-recaptcha-badge',
    	'label'   => __( 'Show reCAPTCHA badge', 'citylogic' ),
    	'section' => $section,
    	'type'    => 'checkbox',
    	'default' => 1,
		'description' => __( '<p>Uncheck this only if you have added the required Google attribution text near your contact forms</p>', 'citylogic' )
	);
    
    // Gutenberg Settings
    $section = 'citylogic-gutenberg';
    
    $sections[] = array(
    	'id' => $section,
    	'title' => __( 'Gutenberg', 'citylogic' ),
    	'priority' => '50'
    );
    
    $options['citylogic-gutenberg-enable-block-based-widgets'] = array(
    	'id' => 'citylogic-gutenberg-enable-block-based-widgets',
    	'label'   => __( 'Enable block-based widgets editor', 'citylogic' ),
    	'section' => $section,
    	'type'    => 'checkbox',
    	'default' => 0
    );
